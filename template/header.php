    ...
    <div class="row">
        <div class="col-12 no-gutter">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="<?php echo("index.php"); ?>">Cara art</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo("art_list.php?page=0"); ?>">Art List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo("appointment.php"); ?>">Appointment</a>
                        </li>
                    </ul>
                    <a  class="navbar-brand" href="<?php echo("admin.php"); ?>">Admin</a>
